...
export default function About() {
    return (
        <Layout>
            ...
            <p>
                The problem I think about the most is how to unlock hidden human potential. Talent is everywhere, opportunity is not. I want to provide the exposure needed for adolescents to find their “spark”. While nature (genes) is a factor in forming our character, our genes and our environment interact. We are ever evolving creatures, even during our lifetime. I want to take a bet on the unknowns, the ones that our society failed them. I want to find the ones that are curious enough to develop their passions, but not fortunate enough with the resources. I want to find the lost minds.
            </p>
            <p>
